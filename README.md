...
- **Multi-Protocol File Sharing**: Integrated WebDAV, SMB3 (port 445), and NFSv4 (port 2049) support for native mounting across macOS, Windows, Linux, iOS, and Android.
...
```bash
bash scripts/deploy-k1.sh <spacemit-k1-ip>
```
